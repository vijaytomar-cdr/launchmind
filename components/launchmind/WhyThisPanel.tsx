 ...
 *   Uses violet border and ai-d background to signal AI provenance.
  ...
  return (
    ...
    >
      <button
        ...
        style={{ fontSize: 12, color: 'var(--ai)', fontWeight: 500 }}
      >
        <span>Why this</span>
      ...
      {open && (
        <div
          ...
          style={{ borderTop: '1px solid var(--ai-b)' }}
        >
          {signal && (
            <Row label="Signal">
...
function Row({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-start gap-2 pt-2">
      <span
        style={{ fontSize: 11, color: 'var(--ai-l)', fontWeight: 500, minWidth: 72 }}
      >
        {label}
      </span>
